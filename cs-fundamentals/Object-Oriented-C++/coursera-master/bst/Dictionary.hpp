...
const D& Dictionary<K, D>::_remove(TreeNode*& node) {
  ...
  // Two-child remove
    ...
    // swap until target does not have any children, then delete
...
typename Dictionary<K, D>::TreeNode*& Dictionary<K, D>::_swap_nodes(
  ...
  std::cout << "node1: " << node1->key << std::endl;               //19
  std::cout << "node1.left: " << node1->left->key << std::endl;    //4
  std::cout << "node1.right: " << node1->right->key << std::endl;  //20
  std::cout << "node2: " << node2->key << std::endl;               //4
  std::cout << "node2.left: " << node2->left->key << std::endl;    //2
  //std::cout << "node2.right: " << node2->right->key << std::endl;  //nullptr
  ...
  if (node1->left == node2) {
    ...
    //std::cout << "node1.right: " << node1->right->key << std::endl;  // nullptr
    std::cout << "node2.right: " << node2->right->key << std::endl;  // 20
    ...
    node1->left = orig_node2->left;  // n2=2; orig_node2=4;
    std::cout << std::endl;
    std::cout << "step2: " << std::endl;
    std::cout << "orig_node2.left: " << orig_node2->left->key << std::endl; //2
    std::cout << "orig_node2.right: 20?" << orig_node2->right->key << std::endl; //20
    std::cout << "node1: " << node1->key << std::endl;               //19
    std::cout << "node1.left: " << node1->left->key << std::endl;    //2  
    std::cout << "orig_node1.left: 2!!" << orig_node1->left->key << std::endl;  //2
    std::cout << "node2: 2!!" << node2->key << std::endl;  
    std::cout << "orig_node2: 4!!" << orig_node2->key << std::endl; 
    //std::cout << "node2.left: ?" << node2->left->key << std::endl;   //nullptr
    //std::cout << "node2.right: ?" << node2->right->key << std::endl; //nullptr  
    ...
    std::cout << "orig_node2: " << orig_node2->key << std::endl;     //4
    std::cout << "orig_node2.left: " << orig_node2->left->key << std::endl;  //19 
    std::cout << "orig_node2.right: " << orig_node2->right->key << std::endl;  //20
    std::cout << std::endl;
    std::cout << "orig_node1: " << orig_node1->key << std::endl; //19
    std::cout << "orig_node1.left: " << orig_node1->left->key << std::endl; //2
    //std::cout << "orig_node1.right: " << orig_node1->right->key << std::endl; //nullptr
    std::cout << std::endl;
    std::cout << "node1: " << node1->key << std::endl; //19
    std::cout << "node1.left: " << node1->left->key << std::endl; //2
    //std::cout << "node1.right: " << node1->right->key << std::endl; //nullptr
    ...
    std::cout << "node1: " << node1->key << std::endl; //4
    std::cout << "orig_node1: " << orig_node1->key << std::endl; //19
    std::cout << "node1.left: " << node1->left->key << std::endl; //19
    std::cout << "node1.right: " << node1->right->key << std::endl; //20
    std::cout << "orig_node1.left: " << orig_node1->left->key << std::endl; //2
    //std::cout << "orig_node1.right: " << orig_node1->right->key << std::endl; //nullptr
    std::cout << "node1.left.left: 2!!!" << node1->left->left->key << std::endl; 
    ...
    std::cout << "node1.left: " << node1->left->key << std::endl;
    return node1->left;
